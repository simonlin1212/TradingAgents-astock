...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date, start_date=None):
        ...
        try:
            return self._run_graph(company_name, trade_date, start_date)
        finally:
    ...
    def _run_graph(self, company_name, trade_date, start_date=None):
        """Execute the graph and write the resulting state to disk and memory log."""
        # Initialize state — inject memory log context for PM.
        past_context = self.memory_log.get_past_context(company_name)
        init_agent_state = self.propagator.create_initial_state(
            company_name, trade_date, past_context=past_context, start_date=start_date
        )
